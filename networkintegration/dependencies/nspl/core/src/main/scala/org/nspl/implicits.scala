...
trait ImplicitConversions {
  ...
  implicit def dsToTuple2b_3D[T, F: FC](ds: (T, List[DataRenderer3D]))(
      implicit f: T => DataSource
  ): PlotData3D =
    (ds._1, ds._2, NotInLegend)
  ...
  implicit def dsToTuple3c_3D[T, F: FC](
      ds: ((T, DataRenderer3D), LegendConfig)
  )(
      implicit f: T => DataSource
  ): PlotData3D = (ds._1._1, List(ds._1._2), ds._2)
  ...
  implicit def dsToTuple2c_3D[T, F: FC](ds: (T, DataRenderer3D))(
      implicit f: T => DataSource
  ): PlotData3D = (ds._1, List(ds._2), NotInLegend)

  implicit def dsToTuple3[T, F: FC](ds: (T, DataRenderer, LegendConfig))(
      implicit f: T => DataSource
  ): PlotData = (ds._1, List(ds._2), ds._3)
  implicit def dsToTuple3_3D[T, F: FC](ds: (T, DataRenderer3D, LegendConfig))(
      implicit f: T => DataSource
  ): PlotData3D = (ds._1, List(ds._2), ds._3)
